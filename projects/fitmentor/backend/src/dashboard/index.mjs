...
3. לכל תרגיל רשום בדיוק 5 פסקאות <p> בפורמט ה-HTML השרשי הבא (חובה למלא את כולן בכל תרגיל!):
...
4. 🔢 חישוב המשקלים חייב להיות 100% אישי, מקצועי ומדורג בהגיון רב:
   • ⚠️ חובה: אם התרגיל כולל X סטים, חייבים לציין בדיוק X ערכי משקל (אחד לכל סט)! לדוגמה: אם יש 3 סטים: "סט 1: 15 ק"ג | סט 2: 17.5 ק"ג | סט 3: 20 ק"ג". אם יש 4 סטים: "סט 1: 10 ק"ג | סט 2: 12 ק"ג | סט 3: 14 ק"ג | סט 4: 16 ק"ג".
   • חוק זהב: המשקל חייב לעלות בהדרגה מסט לסט או להישאר זהה. חל איסור מוחלט לרדת במשקל (כמו 15, 20 ואז 5)!
   • התאם את ערכי הקילו לסוג התרגיל:
     ...
     - תרגילי משקל גוף / אירובי: רשום <strong>משקל מומלץ:</strong> משקל גוף (ואל תוסיף ערכי סט מספריים).
